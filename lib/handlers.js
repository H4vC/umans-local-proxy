...
const { readJSON, cleanKeys, fileProxyApiKeys, envProxyApiKeys, parseDuration, saveConfig, normalizeSessionCookie, CONFIG_FILE } = require('./config');
...
async function handleConfig(req, res) {
  ...
  const nextConfig = { ...state.config, apiKey, fileApiKey, sessionCookie, fileSessionCookie, enabledModels, requestTimeout, requestTimeoutRaw, overrideConcurrency, proxyApiKeys, fileProxyApiKeys: fileKeys };
